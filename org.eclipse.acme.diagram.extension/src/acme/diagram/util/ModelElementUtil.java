...
public class ModelElementUtil {
	...
	public static String getIntrinsicID(ModelElement modelElement) {
		String string = ModelElementFeatureUtil.getName(modelElement);
		ModelElement container = (ModelElement) modelElement.eContainer();
		ModelElement root = getRootElement(modelElement);
		while (container != root) {
			string = ModelElementFeatureUtil.getName(container) + "-" + string;
