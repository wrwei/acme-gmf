...
public class DimensionUtil {
	...
	public static final Dimension ASSERTED_EVIDENCE_DIMENSION = new Dimension(20, 20);
	public static final Dimension ASSERTED_INFERENCE_DIMENSION = new Dimension(20, 20);
	public static final Dimension ASSERTED_CONTEXT_DIMENSION = new Dimension(20, 20);
	...
	public static Rectangle getConstraints(ModelElement modelElement, Rectangle rectangle) {
		...
		if (modelElement instanceof Module) {
			...
			if (!moduleReference.isUninstantiated()) {
				...
				aspRatio = MODULE_DIMENSION.preciseWidth()/(MODULE_DIMENSION.preciseHeight() + ModuleReferenceShape.TRIANGLE_DECORATION_HEIGHT);
			}
		}
...
//			}
			...
			aspRatio = RESOURCE_DIMENSION.width/RESOURCE_DIMENSION.height;
		}
		else if (modelElement instanceof ArtifactReference) {
			aspRatio = ARTIFACT_REFERENCE_DIMENSION.preciseWidth()/ARTIFACT_DIMENSION.preciseHeight();
		}
		...
		ret.width = (int)Math.round(width);
		ret.height = (int)Math.round(height);
		return ret;
	}
