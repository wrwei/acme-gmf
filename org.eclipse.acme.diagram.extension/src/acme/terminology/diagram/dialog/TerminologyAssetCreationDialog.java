...
public class TerminologyAssetCreationDialog extends ModelElementPropertyDialog {
		...
		combo.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				case 1:
					...
					createImplementationGroup(container);
					container.layout();
					resizeShell();
					selectedIndex = 1;
					break;
	...
	protected void hideImplementGroup() {
		if (implementaionGroup != null) {
			if (!implementaionGroup.isDisposed()) {
				implementaionGroup.getParent().dispose();
			}
		}
	}
	...
	public TerminologyAsset getCreatedTerminoloyAsset() {
		...
		ModelElementUtil.createName(result, getName());
		ModelElementUtil.createDescription(result, getDescription(0));
		ModelElementFeatureUtil.createImplementationConstraint(result, getImplementationConstraint(0));
		return result;
	}
}
