...
public class RunScriptDialog extends ModelElementPropertyDialog{

	private Text script_text = null;
	private String script_string = "";
	public RunScriptDialog(Shell parentShell, ModelElement modelElement) {
		super(parentShell, modelElement);
	}

	@Override
	protected String getTitleString() {
		return "Run Epsilon Script";
	}
	...
	protected void createRunScriptGroup(Composite parent) {
		...
		implementationConstraintLabel.setText("Query:");
