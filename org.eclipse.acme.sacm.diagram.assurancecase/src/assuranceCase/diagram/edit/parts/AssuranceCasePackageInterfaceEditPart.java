	...
	*/
	...
	public class AssuranceCasePackageInterfaceFigure extends AssuranceCasePackageInterfaceShape {
		...
		private void createContents() {
			...
			this.add(fFigureAcpiName, new Rectangle(5 + AssuranceCasePackageInterfaceShape.TOP_RECT_WIDTH_OFFSET, AssuranceCasePackageInterfaceShape.TOP_RECT_HEIGHT + 5,
			...
			Dimension descriptionDimension = DimensionUtil.getTextSize(fFigureAcpiDescription.getText(),
					fFigureAcpiDescription.getFont(), DimensionUtil.ASSURANCE_PACKAGE_DIMENSION.width - 10);

			this.add(fFigureAcpiDescription, new Rectangle(5 + AssuranceCasePackageInterfaceShape.TOP_RECT_WIDTH_OFFSET, AssuranceCasePackageInterfaceShape.TOP_RECT_HEIGHT + 35,
	...
	private void adjustLabelPositions()
	{
		...
		WrappingLabel nameLabel = getPrimaryShape().getFigureAcpiName();
		nameLabel.setText(ModelElementFeatureUtil.getName(assuranceCasePackageInterface));
		Dimension nameDimension = DimensionUtil.getTextSize(nameLabel.getText(), nameLabel.getFont());
		getPrimaryShape().setConstraint(nameLabel, new Rectangle(5 + AssuranceCasePackageInterfaceShape.TOP_RECT_WIDTH_OFFSET, AssuranceCasePackageInterfaceShape.TOP_RECT_HEIGHT + 5,
				nameDimension.width, nameDimension.height));
		
		WrappingLabel descriptionLabel = getPrimaryShape().getFigureAcpiDescription();
		descriptionLabel.setText(ModelElementFeatureUtil.getDescription(assuranceCasePackageInterface));
		...
		getPrimaryShape().setConstraint(descriptionLabel,
				new Rectangle(5 + AssuranceCasePackageInterfaceShape.TOP_RECT_WIDTH_OFFSET, AssuranceCasePackageInterfaceShape.TOP_RECT_HEIGHT + 35,
						descriptionDimension.width, descriptionDimension.height));
	}
}
