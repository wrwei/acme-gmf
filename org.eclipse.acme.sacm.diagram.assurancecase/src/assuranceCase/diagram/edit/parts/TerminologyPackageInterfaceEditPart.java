	...
	*/
	...
	public class TerminologyPackageInterfaceFigure extends TerminologyPackageInterfaceShape {
		...
		private void createContents() {
			...
			this.add(fFigureTpiName, new Rectangle(5 + TerminologyPackageInterfaceShape.TOP_RECT_WIDTH_OFFSET, TerminologyPackageInterfaceShape.TOP_RECT_HEIGHT + 5,
			...
			this.add(fFigureTpiDescription, new Rectangle(5 + TerminologyPackageInterfaceShape.TOP_RECT_WIDTH_OFFSET, TerminologyPackageInterfaceShape.TOP_RECT_HEIGHT + 35,
	...
	private void adjustLabelPositions()
	{
		...
		WrappingLabel nameLabel = getPrimaryShape().getFigureTpiName();
		nameLabel.setText(ModelElementFeatureUtil.getName(terminologyPackageInterface));
		Dimension nameDimension = DimensionUtil.getTextSize(nameLabel.getText(), nameLabel.getFont());
		getPrimaryShape().setConstraint(nameLabel, new Rectangle(5 + TerminologyPackageInterfaceShape.TOP_RECT_WIDTH_OFFSET, TerminologyPackageInterfaceShape.TOP_RECT_HEIGHT + 5,
				nameDimension.width, nameDimension.height));
		
		WrappingLabel descriptionLabel = getPrimaryShape().getFigureTpiDescription();
		descriptionLabel.setText(ModelElementFeatureUtil.getDescription(terminologyPackageInterface));
		...
		getPrimaryShape().setConstraint(descriptionLabel,
				new Rectangle(5 + TerminologyPackageInterfaceShape.TOP_RECT_WIDTH_OFFSET, TerminologyPackageInterfaceShape.TOP_RECT_HEIGHT + 35,
						descriptionDimension.width, descriptionDimension.height));
	}
