	...
	*/
	...
	public class AssuranceCasePackageBindingFigure extends AssuranceCasePackageBindingShape {
		...
		private void createContents() {
			...
			this.add(fFigureAcpbName, new Rectangle(5 + AssuranceCasePackageBindingShape.TOP_RECT_WIDTH_OFFSET, AssuranceCasePackageBindingShape.TOP_RECT_HEIGHT + 5,
			...
			Dimension descriptionDimension = DimensionUtil.getTextSize(fFigureAcpbDescription.getText(),
					fFigureAcpbDescription.getFont(), DimensionUtil.ASSURANCE_PACKAGE_BINDING_DIMENSION.width - 10);

			this.add(fFigureAcpbDescription, new Rectangle(5 + AssuranceCasePackageBindingShape.TOP_RECT_WIDTH_OFFSET, AssuranceCasePackageBindingShape.TOP_RECT_HEIGHT + 35,
	...
	private void adjustLabelPositions()
	{
		...
		WrappingLabel nameLabel = getPrimaryShape().getFigureAcpbName();
		nameLabel.setText(ModelElementFeatureUtil.getName(assuranceCasePackageBinding));
		Dimension nameDimension = DimensionUtil.getTextSize(nameLabel.getText(), nameLabel.getFont());
		getPrimaryShape().setConstraint(nameLabel, new Rectangle(5 + AssuranceCasePackageBindingShape.TOP_RECT_WIDTH_OFFSET, AssuranceCasePackageBindingShape.TOP_RECT_HEIGHT + 5,
				nameDimension.width, nameDimension.height));
		
		WrappingLabel descriptionLabel = getPrimaryShape().getFigureAcpbDescription();
		descriptionLabel.setText(ModelElementFeatureUtil.getDescription(assuranceCasePackageBinding));
		...
		getPrimaryShape().setConstraint(descriptionLabel,
				new Rectangle(5 + AssuranceCasePackageBindingShape.TOP_RECT_WIDTH_OFFSET, AssuranceCasePackageBindingShape.TOP_RECT_HEIGHT + 35,
						descriptionDimension.width, descriptionDimension.height));
	}
