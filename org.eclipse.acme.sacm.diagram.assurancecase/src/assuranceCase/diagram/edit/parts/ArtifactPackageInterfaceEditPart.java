	...
	*/
	...
	public class ArtifactPackageInterfaceFigure extends ArtifactPackageInterfaceShape {
		...
		private void createContents() {
			...
			this.add(fFigureApiName, new Rectangle(5 + ArtifactPackageInterfaceShape.TOP_RECT_WIDTH_OFFSET, ArtifactPackageInterfaceShape.TOP_RECT_HEIGHT + 5,
			...
			this.add(fFigureApiDescription, new Rectangle(5 + ArtifactPackageInterfaceShape.TOP_RECT_WIDTH_OFFSET, ArtifactPackageInterfaceShape.TOP_RECT_HEIGHT + 35,
	...
	private void adjustLabelPositions()
	{
		...
		WrappingLabel nameLabel = getPrimaryShape().getFigureApiName();
		nameLabel.setText(ModelElementFeatureUtil.getName(artifactPackageInterface));
		Dimension nameDimension = DimensionUtil.getTextSize(nameLabel.getText(), nameLabel.getFont());
		getPrimaryShape().setConstraint(nameLabel, new Rectangle(5 + ArtifactPackageInterfaceShape.TOP_RECT_WIDTH_OFFSET, ArtifactPackageInterfaceShape.TOP_RECT_HEIGHT + 5,
				nameDimension.width, nameDimension.height));
		
		WrappingLabel descriptionLabel = getPrimaryShape().getFigureApiDescription();
		descriptionLabel.setText(ModelElementFeatureUtil.getDescription(artifactPackageInterface));
		...
		getPrimaryShape().setConstraint(descriptionLabel,
				new Rectangle(5 + ArtifactPackageInterfaceShape.TOP_RECT_WIDTH_OFFSET, ArtifactPackageInterfaceShape.TOP_RECT_HEIGHT + 35,
						descriptionDimension.width, descriptionDimension.height));
	}
}
