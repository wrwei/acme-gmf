	...
	*/
	...
	public class InContextOfFigure extends InContextOfStraightConnection {
		...
		private void createContents() {
			...
			InContextOf inContextOf = (InContextOf) resolveSemanticElement();
			if (inContextOf.getCitedElement() != null) {
				fFigureInContextOfLabel.setText(ModelElementFeatureUtil.getName(resolveSemanticElement()));	
			}
			else {
	...
	private void refreshACPLabel()
	{
		InContextOf inContextOf = (InContextOf) resolveSemanticElement();
		if (inContextOf.getCitedElement() != null) {
			getPrimaryShape().getFigureInContextOfLabel().setText(ModelElementFeatureUtil.getName(resolveSemanticElement()));	
		}
		else {
			getPrimaryShape().getFigureInContextOfLabel().setText("");	
		}
	}
