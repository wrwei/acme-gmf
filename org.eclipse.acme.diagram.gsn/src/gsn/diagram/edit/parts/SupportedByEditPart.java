...
public class SupportedByEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	*/
	...
	public class SupportedByFigure extends SupportedByStraightConnection {
		...
		private void createContents() {
			...
			if (supportedBy.getCitedElement() != null) {
				fFigureSupportedByLabel.setText(ModelElementFeatureUtil.getName(resolveSemanticElement()));	
			}
			else {
	...
	private void refreshACPLabel()
	{
		SupportedBy supportedBy = (SupportedBy) resolveSemanticElement();
		if (supportedBy.getCitedElement() != null) {
			getPrimaryShape().getFigureSupportedByLabel().setText(ModelElementFeatureUtil.getName(resolveSemanticElement()));	
		}
		else {
			getPrimaryShape().getFigureSupportedByLabel().setText("");	
		}
	}
