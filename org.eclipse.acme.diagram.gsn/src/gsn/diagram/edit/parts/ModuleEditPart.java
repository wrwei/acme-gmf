...
//				System.out.println(request);
	...
	*/
	...
	private void adjustLabelPositions()
	{
		...
		WrappingLabel nameLabel = getPrimaryShape().getFigureModuleName();
		...
		getPrimaryShape().getLayoutManager().setConstraint(nameLabel, new Rectangle(5, ModuleShape.TOP_RECT_HEIGHT + 5, nameDimension.width, nameDimension.height));
		
		
		WrappingLabel descriptionLabel = getPrimaryShape().getFigureModuleDescription();
		...
		getPrimaryShape().getLayoutManager().setConstraint(descriptionLabel,
				new Rectangle(5, ModuleShape.TOP_RECT_HEIGHT + 35, descriptionDimension.width, descriptionDimension.height));
	}
