...
public class ProvideJustificationHandler implements IHandler {
...
//		System.out.println(createClaimViewRequest.getNewObject());
		...
		claim.setAssertionDeclaration(AssertionDeclaration.AXIOMATIC);
		
//		TransactionalEditingDomain editingDomain;
//		editingDomain = TransactionalEditingDomain.Registry.INSTANCE.getEditingDomain("org.eclipse.acme.EditingDomain");
//		ModelElementFeatureUtil.setFeatureTransactional(editingDomain, claim, Argumentation_Package.eINSTANCE.getAssertion_AssertionDeclaration(), AssertionDeclaration.AXIOMATIC);
